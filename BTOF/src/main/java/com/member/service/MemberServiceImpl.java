...
public class MemberServiceImpl implements MemberService{
	...
	public int checkId_PW(String id , String pwch) {
		int result = memberMapper.checkId_PW(id, pwch);
		return result;
	}
...
//
	...
	public String checkBankAccount(String id) {
		String result = memberMapper.checkBankAccount(id);
		return result;
	}

	@Override
	public void updateBank_account(String id) {
			memberMapper.updateBank_account(id);
	}

	@Override
	public MemberVO getMemberInfoForMypage(String id) {
			MemberVO member = memberMapper.getMemberInfoForMypage(id);
