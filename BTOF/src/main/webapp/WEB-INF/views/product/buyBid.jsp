...
<br /><br /><br />
    ...
    <script type="text/javascript">
	    ...
	    console.log(now.getTime() === end_time.getTime());
    	var dif = Math.abs(end_time.getTime() - now.getTime());
    ...
    <script type="text/javascript">
	   	function remaindTime() {
	   	    var now = new Date();
	   	    console.log(now);
	   	 	var close = new Date(2022,03,26,16,43,30); // end 시간으로 세팅
	   	    var nt = now.getTime();
	   	    console.log(nt);
	   	    var ct = close.getTime();
	   	    console.log(ct);
